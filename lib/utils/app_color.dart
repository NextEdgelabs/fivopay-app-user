...
class NewAppColors extends ThemeExtension<NewAppColors> {
  ...
  static const dark = NewAppColors(
    ...
    bgColors: Color(0xFF0A0F15), // Deep dark blue-black
    specialCard: Color(0xFF141C24), // Dark card with blue tint
    specialCardTwo: Color(0xFF1A2530), // Slightly lighter card
    cardBackground: Color(0xFF151D26), // Card background with blue
    navBar: Color(0xFF0C1218), // Darker navigation bar
    popupBg: Color(0xFF141C24), // Popup background
    smallCardBg: Color(0xFF1F2833), // Small card background
    searchFieldFill: Color(0xFF1D252E), // Search field fill
    // Text Colors (Dark Mode)
    heading: Color(0xFFE6F3F5), // Light blue-white for headings
    subheading: Color(0xFFC5DCE4), // Soft blue-gray for subheadings
    text: Color(0xFFB8D4DC), // Blue-tinted text
    textSecondary: Color(0xFFA2BCC8), // Secondary text with blue
    subtext: Color(0xFF8899A6), // Muted blue-gray
    navBarText: Color(0xFFA6C4D4), // Nav bar text
    buttonLabelText: Color(0xFFF0F8FA), // Button label text
    disableButtonText: Color(0xFF7C8A98), // Disabled text
    // Brand & Accent Colors
    brandColor: Color(0xFF1EBDFF), // Primary brand cyan blue
    gradientOne: Color(0xFF1EBDFF), // Gradient start (brand)
    gradientTwo: Color(0xFF5416D8), // Gradient end (purple)
    // Interactive Elements
    backIcon: Color(0xFF72A8B8), // Back icon color
    backIconBorder: Color(0xFF22353D), // Back icon border
    divider: Color(0xFF21333B), // Divider lines
    border: Color(0xFF2F3D47), // Border color
    fieldBorder: Color(0xFF2E3A44), // Field border
    selectedField: Color(0xFF1F2F3A), // Selected field background
    disabled: Color(0xFF2A3032), // Disabled state
    // Status & Alert Colors
  ...
  static const light = NewAppColors(
    ...
    bgColors: Color(0xFFF6F8FA), // Very light blue-white background
    specialCard: Color.fromARGB(255, 255, 255, 255), // Pure white card
    specialCardTwo: Color(0xFFD9EDF7), // Slightly darker cyan card
    cardBackground: Color(0xFFF2F8FC), // Card background with cyan tint
    navBar: Color(0xFFFAFDFF), // Navigation bar
    popupBg: Color(0xFFFFFFFF), // Pure white popup
    smallCardBg: Color(0xFFECF9FF), // Small card background
    searchFieldFill: Color(0xFFEFF7FA), // Search field fill
    // Text Colors (Light Mode)
    heading: Color(0xFF1F2D3A), // Deep blue-black for headings
    subheading: Color(0xFF354558), // Dark blue for subheadings
    text: Color.fromARGB(255, 0, 0, 0), // Dark Black text
    textSecondary: Color(0xFF777777), // Secondary gray text
    subtext: Color(0xFF8F9DAA), // Muted blue text
    navBarText: Color(0xFF688088), // Nav bar text
    buttonLabelText: Color(0xFFFFFFFF), // White button text
    disableButtonText: Color(0xFFAAB8BF), // Disabled text
    // Brand & Accent Colors
    brandColor: Color(0xFF1EBDFF), // Primary brand cyan blue
    gradientOne: Color(0xFF1EBDFF), // Gradient start (brand)
    gradientTwo: Color(0xFF5416D8), // Gradient end (purple)
    // Interactive Elements
    backIcon: Color(0xFF526B78), // Back icon color
    backIconBorder: Color(0xFFDDE8F0), // Back icon border
    divider: Color(0xFFE0EBF2), // Divider lines
    border: Color(0xFFDCDCDC), // Border color
    fieldBorder: Color(0xFFC3D6E3), // Field border
    selectedField: Color(0xFFE6F2FA), // Selected field background
    disabled: Color(0xFFE6F0F5), // Disabled state
    // Status & Alert Colors
    ...
    // Legacy/Special Colors
    famerStrokeGrey: Color(0xFF8F9DAA),
    famerStrokeOrange: Color(0xFFECF9FF),
    buttonColorLight: Color(0xFFEBF5FA),
  );
