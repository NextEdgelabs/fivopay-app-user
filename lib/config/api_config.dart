...
class ApiConfig {
  ...
  static const String aadhaarOtpPath = '/api/v1/app-config/send-aadhar-verification-otp';
  static const String aadhaarVerifyPath = '/api/v1/app-config/verify-aadhar-verification-otp';
 ...
 //Shares
  ...
  //upload
  static const String uploadFile = '/api/v1/file-upload/get-multiple-signed-urls';
  // Headers
