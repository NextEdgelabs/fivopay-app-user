class LoanApplication {
  ...
  factory LoanApplication.fromJson(Map<String, dynamic> json) {
    return LoanApplication(
      ...
      isCurrentAddressSameAsAadhaar: json['isCurrentAddressSameAsAadhaar'] ?? true,
    );
  }
  ...
  LoanApplication copyWith({
    ...
    return LoanApplication(
      ...
      aadhaarVerificationDate: aadhaarVerificationDate ?? this.aadhaarVerificationDate,
      currentAddress: currentAddress ?? this.currentAddress,
      aadhaarAddress: aadhaarAddress ?? this.aadhaarAddress,
      isCurrentAddressSameAsAadhaar: isCurrentAddressSameAsAadhaar ?? this.isCurrentAddressSameAsAadhaar,
    );
  }
}
